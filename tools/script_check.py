...
def check(script_name: str) -> bool:
    ...
    character_check_list = json.load(open("tools/characters.json", "r"))
    travellers_list = json.load(open("tools/travellers.json", "r"))
    fabled_list = json.load(open("tools/fabled.json", "r"))
